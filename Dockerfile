...
run apt update \
	&& apt -y install openssh-server nano unzip wget curl psmisc net-tools aria2 nginx wget lrzsz tmux \
...
run chmod +x /docker-entrypoint.sh && chmod +x /usr/bin/ttyd.x86_64
cmd []
